...
inline ktvr::K2TrackingDeviceBase_JointsBasis* _this_Device;

// Typedefs to save line space
using _TextBlock = Managed_JointsBasis_Handler::AmethystDevice::TextBlock;
using _Button = Managed_JointsBasis_Handler::AmethystDevice::Button;
using _NumberBox = Managed_JointsBasis_Handler::AmethystDevice::NumberBox;
using _ComboBox = Managed_JointsBasis_Handler::AmethystDevice::ComboBox;
using _CheckBox = Managed_JointsBasis_Handler::AmethystDevice::CheckBox;
using _ToggleSwitch = Managed_JointsBasis_Handler::AmethystDevice::ToggleSwitch;
using _TextBox = Managed_JointsBasis_Handler::AmethystDevice::TextBox;
using _ProgressRing = Managed_JointsBasis_Handler::AmethystDevice::ProgressRing;
using _ProgressBar = Managed_JointsBasis_Handler::AmethystDevice::ProgressBar;
...
namespace Interface
{
	...
	inline System::Guid CreateButton(System::String^ content)
	{
		...
		_Button_Map[GUIDString(_m_guid)]->OnClick =
			[_m_guid_str](auto)
			{
				Managed_JointsBasis_Handler::AmethystDevice::ExecuteButtonHandler(
	...
	inline System::Guid CreateNumberBox(const int value)
	{
		...
		_NumberBox_Map[GUIDString(_m_guid)]->OnValueChanged =
			...
			{
				Managed_JointsBasis_Handler::AmethystDevice::ExecuteNumberBoxHandler(
	...
	inline System::Guid CreateComboBox(System::Collections::Generic::List<System::String^>^ items)
	{
		...
		_ComboBox_Map[GUIDString(_m_guid)]->OnSelectionChanged =
			[_m_guid_str](auto, auto val)
			{
				Managed_JointsBasis_Handler::AmethystDevice::ExecuteComboBoxHandler(
					StringGUID(_m_guid_str), val);
			};
	...
	inline System::Guid CreateCheckBox()
	{
		...
		_CheckBox_Map[GUIDString(_m_guid)]->OnChecked =
			[_m_guid_str](auto)
			{
				Managed_JointsBasis_Handler::AmethystDevice::ExecuteCheckBoxHandler(
	...
	inline System::Guid CreateTextBox()
	{
		...
		_TextBox_Map[GUIDString(_m_guid)]->OnEnterKeyDown =
			...
			{
				Managed_JointsBasis_Handler::AmethystDevice::ExecuteTextBoxHandler(
					StringGUID(_m_guid_str),
	...
	{
		if (element->GetType() == Managed_JointsBasis_Handler::AmethystDevice::TextBlock::typeid &&
		...
		else if (element->GetType() == Managed_JointsBasis_Handler::AmethystDevice::Button::typeid &&
		...
		else if (element->GetType() == Managed_JointsBasis_Handler::AmethystDevice::NumberBox::typeid &&
		...
		else if (element->GetType() == Managed_JointsBasis_Handler::AmethystDevice::ComboBox::typeid &&
		...
		else if (element->GetType() == Managed_JointsBasis_Handler::AmethystDevice::CheckBox::typeid &&
		...
		else if (element->GetType() == Managed_JointsBasis_Handler::AmethystDevice::ToggleSwitch::typeid &&
		...
		else if (element->GetType() == Managed_JointsBasis_Handler::AmethystDevice::TextBox::typeid &&
		...
		else if (element->GetType() == Managed_JointsBasis_Handler::AmethystDevice::ProgressRing::typeid &&
		...
		else if (element->GetType() == Managed_JointsBasis_Handler::AmethystDevice::ProgressBar::typeid &&
	...
	inline void AppendElementPair(System::Object^ element_1, System::Object^ element_2)
	{
		...
		// Element_1
		{
			if (element_1->GetType() == Managed_JointsBasis_Handler::AmethystDevice::TextBlock::typeid &&
			...
			else if (element_1->GetType() == Managed_JointsBasis_Handler::AmethystDevice::Button::typeid &&
			...
			else if (element_1->GetType() == Managed_JointsBasis_Handler::AmethystDevice::NumberBox::typeid &&
			...
			else if (element_1->GetType() == Managed_JointsBasis_Handler::AmethystDevice::ComboBox::typeid &&
			...
			else if (element_1->GetType() == Managed_JointsBasis_Handler::AmethystDevice::CheckBox::typeid &&
			...
			else if (element_1->GetType() == Managed_JointsBasis_Handler::AmethystDevice::ToggleSwitch::typeid &&
			...
			else if (element_1->GetType() == Managed_JointsBasis_Handler::AmethystDevice::TextBox::typeid &&
			...
			else if (element_1->GetType() == Managed_JointsBasis_Handler::AmethystDevice::ProgressRing::typeid &&
			...
			else if (element_1->GetType() == Managed_JointsBasis_Handler::AmethystDevice::ProgressBar::typeid &&
		...
		// Element_2
		{
			if (element_2->GetType() == Managed_JointsBasis_Handler::AmethystDevice::TextBlock::typeid &&
			...
			else if (element_2->GetType() == Managed_JointsBasis_Handler::AmethystDevice::Button::typeid &&
			...
			else if (element_2->GetType() == Managed_JointsBasis_Handler::AmethystDevice::NumberBox::typeid &&
			...
			else if (element_2->GetType() == Managed_JointsBasis_Handler::AmethystDevice::ComboBox::typeid &&
			...
			else if (element_2->GetType() == Managed_JointsBasis_Handler::AmethystDevice::CheckBox::typeid &&
			...
			else if (element_2->GetType() == Managed_JointsBasis_Handler::AmethystDevice::ToggleSwitch::typeid &&
			...
			else if (element_2->GetType() == Managed_JointsBasis_Handler::AmethystDevice::TextBox::typeid &&
			...
			else if (element_2->GetType() == Managed_JointsBasis_Handler::AmethystDevice::ProgressRing::typeid &&
			...
			else if (element_2->GetType() == Managed_JointsBasis_Handler::AmethystDevice::ProgressBar::typeid &&
...
namespace Helpers
{
	...
	inline array<Managed_JointsBasis_Handler::API_Projection_Files::TrackedJoint^>^ GetAppJointPoses()
	{
		...
		auto tracker_array = gcnew array<Managed_JointsBasis_Handler::API_Projection_Files::TrackedJoint^>(
			joints.size());
...
{
	public ref class Amethyst_API_Managed_Device : Managed_JointsBasis_Handler::AmethystDevice
	{
	public:
		Amethyst_API_Managed_Device()
		{
			...
			GetAppJointPoses = gcnew System::Func<array<
				Managed_JointsBasis_Handler::API_Projection_Files::TrackedJoint^>^>(&Helpers::GetAppJointPoses);
...
{
	__declspec(dllexport) void RegisterDevice(ktvr::K2TrackingDeviceBase_JointsBasis* handler)
	{
