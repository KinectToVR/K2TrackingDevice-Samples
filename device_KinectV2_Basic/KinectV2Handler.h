...
public:
	...
	KinectV2Handler()
	{
		...
		K2TrackingDeviceBase_KinectBasis::deviceName = "XBONE Kinect (Basic)";

		K2TrackingDeviceBase_KinectBasis::deviceCharacteristics = ktvr::K2_Character_Basic;
		K2TrackingDeviceBase_KinectBasis::flipSupported = true;
		K2TrackingDeviceBase_KinectBasis::appOrientationSupported = false; // No math-based here :(
	}
